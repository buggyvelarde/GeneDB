...
public class MRNA extends ProductiveTranscript {
    ...
    public MRNA(Organism organism, String systematicId, boolean analysis, boolean obsolete,
            Timestamp dateAccessioned) {
        super(organism, systematicId, analysis, obsolete, dateAccessioned);
    }

    public static MRNA make(Feature parent, StrandedLocation location, String systematicId,
    ...
    // static MRNA make(Feature parent, Location loc, Organism organism, String
    // systematicId, String type, Timestamp now) {
    //		
    // MRNA mrna = new MRNA(organism, systematicId, false, false, now);
    // parent.addLocatedChild(mRNA, location);
    // return mrna;
