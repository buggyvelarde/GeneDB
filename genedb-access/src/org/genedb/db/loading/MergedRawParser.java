...
public class MergedRawParser implements CharSVParsingListener {
    ...
    public MergedRawParser(Reader input, Map cache, boolean discardDupNodes, 
        ...
        public MergedRawParser(Map cache, String filename, double score) {
            ...
            if ( fl.isDirectory() ) {
                ...
                for (int i=0; i < fls.length; i++) {
                    new InterProParser(cache, filename+"/"+fls[i], score);
                }
                return;
            }
...
//                }
                ...
                while ( it.hasNext()) {
                    ...
                    for ( int i = min; i <= max ; i++) {
                        ...
                        if (thisRow.length >= COL_GO+1) {
                            ...
                            addGoTerms(brna, thisRow, goIdsLinked);
                        }
                    }
                    ...
                    while ( it2.hasNext() ) {
                        ...
                        if ( db == null ) {
                            ...
                            brna.addDBLink(link, DBLinkType.DB_XREF);
                        }
                    }
                }
        ...
        private void addGoTerms(BaseRNA gene, String[] row, Set goIdsLinked) {
