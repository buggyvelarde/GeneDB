...
public class Cirad_CDS_Processor extends CDS_Processor {
	...
	/**
	 * This is called once the basic gene structure has been created. 
	 * It calls the base class copy to process common qualifiers like
	 * 'note'. The following is an example of the code to process a 
	 * /evidence qualifier. The code is written so that you can have 
	 * multiple values for a given qualifier, although the if statement
	 * stops that here.   
	 *   
	 * @see org.genedb.db.loading.featureProcessors.CDS_Processor#processQualifiers(Feature, Annotation)
	 */
