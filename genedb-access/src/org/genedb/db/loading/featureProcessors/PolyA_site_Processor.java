...
public class PolyA_site_Processor extends BaseFeatureProcessor {
    ...
    public void processStrandedFeature(Feature parent, StrandedFeature feat, int offset) {
        ...
        if (above == null) {
            above = tieToFeatureByLocation("polyA_site", "polyA_signal_sequence", parent, feat, loc);
            
        }
        if (above == null) {
            above = tieToFeatureByLocation("polyA_site", "three_prime_UTR", parent, feat, loc);
    ...
    private Feature tieToFeatureByLocation(String type, String aboveType, Feature parent, StrandedFeature feat, Location loc) {
