...
public class PolyA_signal_Processor extends BaseFeatureProcessor {
    ...
    public void processStrandedFeature(Feature parent, StrandedFeature feat, int offset) {
        ...
        if (above == null) {
            above = tieTo3PrimeUtrByLocation(type, parent, feat, location);
    ...
    private Feature tieTo3PrimeUtrByLocation(String type, Feature parent, StrandedFeature feat, StrandedLocation loc) {
