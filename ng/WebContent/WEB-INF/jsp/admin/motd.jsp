...
<script type="text/javascript" src="<misc:url value="/includes/scripts/tiny_mce/jquery.tinymce.js">"></script>
...
script_url : '<misc:url value="/includes/scripts/tiny_mce/jquery.tinymce.js">',
...
<label for="content" >Message of the Day</label>
