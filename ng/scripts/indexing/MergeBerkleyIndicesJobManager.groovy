...
execLine="java -server -Djava.awt.headless=true -Xms1000m -Xmx2000m -XX:+HeapDumpOnOutOfMemoryError -XX:-UseGCOverheadLimit -classpath ${cacheClassPath}  org.genedb.web.mvc.model.MergeBerkeleyIndices -r ${TO} ${FROM} "
