...
for (org in orgs) {
    ...
    case "DTO":
		...
		execLine="java -server -Djava.awt.headless=true -Xmx1024m -classpath ${cacheClassPath} org.genedb.web.mvc.model.PopulateCaches -o ${org} --globalFileRoot ${baseDir}/output/${org} "
        new File("${baseDir}/output/${org}").mkdir()
        break;
