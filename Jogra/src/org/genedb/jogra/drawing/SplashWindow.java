 ...
 * A Splash window.
 *  <p>
 * Usage: MyApplication is your application class. Create a GeneDB class which
 * opens the splash window, invokes the main method of your Application class,
 * and disposes the splash window afterwards.
 * Please note that we want to keep the GeneDB class and the SplashWindow class
...
public class SplashWindow extends Window {
     ...
     * @param args the command line arguments
     */
    public static void invokeDisplay(String className) {
        try {
            Class.forName(className).getMethod("display", (Class[])null).invoke(null, (Object[])null);
        } catch (Exception e) {
     ...
     * @param args the command line arguments
     */
    public static void invokeStart(String className) {
		System.err.println("In SplashWindow.invokeStart");
        try {
            Class.forName(className)
            .getMethod("start", (Class[])null)
            .invoke(null, (Object[])null);
        } catch (Exception e) {
            InternalError error = new InternalError("Failed to invoke start method");
            error.initCause(e);
            throw error;
        }
    }
