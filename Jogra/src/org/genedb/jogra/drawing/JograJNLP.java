...
public class JograJNLP implements SingleInstanceListener, PropertyChangeListener, EventSubscriber<GeneDBMessage> {
    ...
    public JograJNLP() throws IOException {
    ...
    public static JograJNLP instantiate() throws IOException {
        ...
        final JograJNLP application = (JograJNLP) ctx.getBean("application", JograJNLP.class);
        ctx.registerShutdownHook();
        return application;
    }
    ...
    public static void main(final String[] args) throws Exception {
	    ...
	    JograJNLP jograJNLP = new JograJNLP();
	    ...
	    sis.removeSingleInstanceListener(jograJNLP);
	    //System.exit(0);
