/* Generated By:JavaCC: Do not edit this line. HistoryParserTokenManager.java */
package org.genedb.web.mvc.history.commandline;

public class HistoryParserTokenManager implements HistoryParserConstants
{
...
"", null, null, null, null, "\52", "\57", "\50", "\51", "\44", null, null, 
null, };
...
public HistoryParserTokenManager(SimpleCharStream stream)
{
   if (SimpleCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public HistoryParserTokenManager(SimpleCharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
