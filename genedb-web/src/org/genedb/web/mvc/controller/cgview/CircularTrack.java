...
public class CircularTrack {
    ...
    public void draw(Graphics2D g2d) throws IOException {
        ...
        for (TrackFeatureRenderDetails renderer : renderers) {
            System.err.println("Looking at renderer '" + renderer + "' foreground='"
                    + renderer.getForeground() + "'");
            // if (!(renderer.getExtentAngle()<0)) {
            double width = 360.0;
            Arc2D arc1 = new Arc2D.Double(-180.0, -180.0, width, width, renderer.getStartAngle(),
                    renderer.getExtentAngle(), Arc2D.OPEN);
            ...
            // Arc2D arc2 = new Arc2D.Double(-200.0, -200.0, 400, 400,
            // renderer.getStartAngle(), half, Arc2D.PIE);
        ...
        // double width = 400.0;
        // Arc2D arc1 = new Arc2D.Double(-200.0, -200.0, width, width, 0, 120,
        // Arc2D.OPEN);
        // g2d.setPaint(Color.RED);
        // g2d.draw(arc1);
        // Arc2D arc2 = new Arc2D.Double(-200.0, -200.0, width, width, 0, -30,
        // Arc2D.OPEN);
        // g2d.setPaint(Color.BLUE);
        // g2d.draw(arc2);
        // Arc2D arc3 = new Arc2D.Double(-200.0, -200.0, width, width, 160, 30,
        // Arc2D.OPEN);
        // g2d.setPaint(Color.RED);
        // g2d.draw(arc3);
        // Arc2D arc4 = new Arc2D.Double(-200.0, -200.0, width, width, 120, 40,
        // Arc2D.OPEN);
        // g2d.setPaint(Color.BLUE);
        // g2d.draw(arc4);
        // Rectangle2D r2d= new Rectangle2D.Double(-100.0, -150.0, 200.0,
        // 300.0);
        // g2d.draw(r2d);
    }
