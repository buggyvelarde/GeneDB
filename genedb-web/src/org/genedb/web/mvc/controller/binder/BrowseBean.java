...
public class BrowseBean implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        cv = cvDao.getCvByName(cvName);

//        if (cvs.size() == 0) {
//            throw new ApplicationContextException("No cv of name '" + cvName
//                    + "' found when configuring " + getClass());
//        }
//        if (cvs.size() > 1) {
//            throw new ApplicationContextException("Too many ('" + cvs.size() + "') cv of name '"
//                    + cvName + "' found when configuring " + getClass());
//        }
//        cv = cvs.get(0);
    }
