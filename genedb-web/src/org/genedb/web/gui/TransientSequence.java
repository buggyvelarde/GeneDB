 ...
 */
public class TransientSequence
  extends
    AbstractChangeable
  implements
    Sequence,
    ...
    Serializable
{
    ...
    private TransientFeatureHolder featureHolder;
    private transient FeatureRealizer featureRealizer;

    private void readObject(ObjectInputStream s)throws IOException, ClassNotFoundException{
        s.defaultReadObject();
        this.featureRealizer = GeneDBFeatureRealizer.getInstance();
    }

    protected FeatureHolder getFeatureHolder() {
        if(featureHolder == null) {
            featureHolder = new TransientFeatureHolder();
// FIXME:           registerFeatureForwarder();
    ...
    */
        ...
        throws BioException, ChangeVetoException
    {
        ...
        TransientFeatureHolder fh = (TransientFeatureHolder) this.getFeatureHolder();
        fh.addFeature(f);
        return f;
    }
   ...
   /**
     ...
     */
    public TransientSequence(SymbolList sym, String urn, String name, Annotation annotation) {
        symList = sym;
     ...
     */
    public TransientSequence(SymbolList sym,
                          String urn,
                          String name,
