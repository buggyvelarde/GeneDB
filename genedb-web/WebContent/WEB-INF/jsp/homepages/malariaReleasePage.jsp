...
<format:genePageSection className="greyBox">
    <div id="frontPage">
	    ...
	    <h3>Example Genes</h3>
	    <ul>
	    <li><a href="NamedFeature?name=PF14_0641">PF14_0641</a></li>
	    <li><a href="NamedFeature?name=PF07_0048">PF07_0048 (VAR)</a></li>
	    </ul>

	    
	    <h3>Organism List</h3>
	    <ul>
			<li><a href="/Homepage?organism=Pfalciparum"><i>Plasmodium falciparum</i></a></li>
	    	<li><a href="/Homepage?organism=Pberghei"><i>Plasmodium berghei</i></a></li>
	    	<li><a href="/Homepage?organism=Pchabaudi"><i>Plasmodium chabaudi</i></a></li>
	    	<li><a href="/Homepage?organism=Pknowlesi"><i>Plasmodium knowlesi</i></a></li>
	    	<li><a href="/Homepage?organism=Pvivax"><i>Plasmodium vivax</i></a></li>
	    	<li><a href="/Homepage?organism=Pyoelli"><i>Plasmodium yoelii</i></a></li>
		</ul>
    </div>                    
