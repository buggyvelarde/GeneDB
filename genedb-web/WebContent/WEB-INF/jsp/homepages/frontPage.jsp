				  					 		...
				  					 		<div id="test">
												...
												<table class="contentpaneopen">
													...
													<tr>
														<td>
															<div style="width: 100%;">
															<div class="fieldset" style="height: 200px; width: 275px;float: left; margin: 2px; background-color: #FAFAD2;">
															...
															<div class="fieldset" style="height: 200px; width: 276px;float: left; margin: 2px; background-color: #FAFAD2;">
															...
															<div class="fieldset" style="width: 569px;float: left; margin-top: 5px;margin-left: 2px; background-color: #FAFAD2;">
