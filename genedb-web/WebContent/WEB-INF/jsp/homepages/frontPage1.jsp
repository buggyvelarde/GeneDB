...
<tr>
	...
	<td width="60%" align="center">
		...
		<a href="http://www.sanger.ac.uk/Projects/Protozoa/"><img class="img-nb" src="<c:url value="/includes/images/bg.jpg"/>" alt="Protozoa" title="Protozoa" style="height: 55px; width: 55px; float: right;"></a>
		<p>All data from these projects are immediately and freely
		available.</p>
		</td>
		</tr>
		...
		<td width="50%"><a href="http://www.sanger.ac.uk/Projects/Virus/">Virus</a>:
		<a href="http://www.sanger.ac.uk/Projects/Virus/"><img class="img-nb" src="<c:url value="/includes/images/vi.jpg"/>" alt="Virus" title="Virus" style="height: 55px; width: 55px; float: right;"></a>
		<p>All data from these projects are immediately and freely
		available.</p>
		</td>
		</tr>
