...
<format:headerRound name="Gene: ${feature.uniqueName}" title="Gene Page ${feature.displayName}">
	<st:init />
...
<tr align="center">
	<td align="center">
		...
		<img align="middle" src="<c:url value="/"/>includes/images/cmap/${feature.uniqueName}.gif"/>
	</td>
</tr>
<tr>
	<td width="80%">
		...
		<div style="float: left;">
			<div style="background-color: #9bd1fa;">
			...
			<tr>
				...
				<td>
		    		<db:list-string collection="${name}" />
				</td>
			</tr>
			</db:synonym>
			...
			<db:synonym name="obsolote_name" var="name" collection="${feature.featureSynonyms}">
			<tr>
				<td>
					<b>Obselete Name</b>
				</td>
			...
			<tr>
				...
				<td>
					<span><uc>${feature.cvTerm.name}</uc></span>
				</td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<c:forEach items="${polypeptide.featureCvTerms}" var="featCvTerm">
						<c:if test="${featCvTerm.cvTerm.cv.name == 'genedb_products'}">
							<span><dd>${featCvTerm.cvTerm.name}</dd></span>
						</c:if>
					</c:forEach>
				</td>
			</tr>
		...
		<div style="float:right;">
			<div style="background-color: #9bd1fa;">
				<span>Genomic Locations</span>
			</div>
			<table class="info" id="loc" cellspacing="0">
			<tr>
				<td>
					<b>Sequence Location</b>
				</td>
				<td>
		...
		<table class="info" id="curation" cellspacing="0" style="clear:both;">
			<tr>
				<th class="bold" style="text-align: left;">
					Curation
				</th>
				<td>
				</td>
			...
			<tr>
				...
				<td>
					<c:set var="url"><c:url value="/"/></c:set>
					<db:curation polypeptide="${polypeptide}" url="${url}"></db:curation>
				</td>
			</tr>
			<tr>
				<th>
		...
		<table class="info" id="ortho" cellspacing="0">
			<tr>
				...
				<td>
					<db:ortholog polypeptide="${polypeptide}"></db:ortholog>
				</td>
			</tr>
		</table>
