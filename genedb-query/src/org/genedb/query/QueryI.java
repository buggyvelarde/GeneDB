...
public interface QueryI extends BasicQueryI {
    ...
    /**
     * Return the type of object that the query returns eg a SO term or
     * publication
     *
     * @return the type
     */
    ...
    /**
     * A string representing the complete query and parameters. Can be parsed
     * back using an appropriate QueryStringParser
     *
    ...
    /**
     * Set a detailer to use for displaying summaries of the results of this
     * query, rather than the default
     *
    ...
    /**
     * Set a detailer to use for displaying a detailed view of one of the
     * results of this query, rather than the default
     *
     * @param detailer The detailer, or null to reset to use the default
     */
