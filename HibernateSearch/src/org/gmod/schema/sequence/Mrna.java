...
public class Mrna extends Feature {
	...
	public String getSynonym() {
		...
		Feature gene = null;
		for (FeatureRelationship relation : objects) {
			gene = relation.getFeatureByObjectId();
			break;
		}
		Collection<FeatureSynonym> synonyms = gene.getFeatureSynonyms();
		String synonym = null;
		boolean first = true;
	...
	@Transient
	@Field(name = "gene",store=Store.YES)
	...
	public String getProtein() {
		...
		Collection<FeatureRelationship> temps = this.getFeatureRelationshipsForObjectId();
